...
// Sort array
export function sortArray<T extends number | string>(
  array: T[],
...
export function removeDuplicatesAndSortArray<T extends number | string>(
  array: T[],
  ascending: boolean = true
): T[] {
...
export function differenceOfTwoDates(
  _startDate: Date | string = new Date(),
  _endDate: string
